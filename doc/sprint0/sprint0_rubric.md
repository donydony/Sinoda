...
**Team Name:** Microsoft
**Github:** https://github.com/UTSCCSCC01/finalprojectw22-microsoft
...
---
## Total Mark  
Sprint 0 Total Mark : 32 / 48
	
## Notes
- It would be good to identify key users as the audience for this game could be everyone or could even be specificly tailored to some.
- User stories should be stating the goal/desire as well as the why/benefit using the format taught in class being "As a ____, I want _____ so that ____"
- The README is lacking a lot of information. Please see the sprint0 handout for more info.
- The definition of done refers to what does "done" mean for a feature that you complete. The definition of done should be applied to all user stories.
