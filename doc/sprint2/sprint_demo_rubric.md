...
## Daily Stand-ups (max 10 marks)
  ...
  Note: some standup messages are low quality, could include more detail. Plus, the number on the standup messages is a little strange, you should all be doing your standups at the same time, so I'm not sure why some people submitted standup 2 while others had standup 5. 
...
Tracking on Jira Total Mark: 10 / 24
