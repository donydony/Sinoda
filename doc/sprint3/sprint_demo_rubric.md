...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 7 / 10 (more detail could be included in the messages, including ticket number. Also, please make sure that all the sprint messages are sent at the same time, so we can verify that everyone was actually at the sprint)
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 (most stories are not split into subtasks)
